...
#include "ROSConds.h"
#include "ROSInst.h"
#include "LearnPNP/ROSLearnInstantiator.h"
#include "LearnPNP/ROSReward.h"
#include "LearnPNP/World/World.h"
#include <ros/ros.h>
...
int main(int argc, char** argv) 
{
	...
	ActionProxy::publisher = n.advertise<PNPros::Action>("pnp_action",1);
