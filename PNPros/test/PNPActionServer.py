...
from PNPros.msg import *
from PNPros.srv import *
...
def executeAction(goalhandler):
  ...
  feedback = PNPros.msg.PNPActionFeedback()
  result   = PNPros.msg.PNPResult()
...
class PNPActionServer(object):
  ...
  _feedback = PNPros.msg.PNPActionFeedback()
  _result   = PNPros.msg.PNPResult()

  def __init__(self, name):
    self._action_server_name = name
    #self._as = actionlib.SimpleActionServer(self._action_name, 
	#           PNPros.msg.PNPAction, execute_cb=self.execute_cb, 
	#           auto_start=False)
    self._as = actionlib.ActionServer(self._action_server_name,
	           PNPros.msg.PNPAction, self.execute_cb, 
	           auto_start=False)
    self._as.start()
...
if __name__ == '__main__':
  ...
  PNPActionServer("PNP")
  rospy.Service('PNPConditionEval', PNPCondition, handle_PNPConditionEval)
  rospy.spin()
