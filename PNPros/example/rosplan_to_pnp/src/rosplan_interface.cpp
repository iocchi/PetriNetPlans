...
public:
  ...
  ROSPlan_Interface(){
    rosplan_sub = nh.subscribe("/kcl_rosplan/plan_graph", 10, &ROSPlan_Interface::plan_callback, this);
...
int main(int argc, char** argv){
  ros::init(argc, argv, "rosplan_interface");

  ROSPlan_Interface interface;
